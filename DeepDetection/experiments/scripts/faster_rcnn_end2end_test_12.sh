#!/bin/bash
# Usage:
# ./experiments/scripts/faster_rcnn_end2end_test_12.sh GPU NET DATASET [options args to {train,test}_net.py]
#
...
time ./tools/test_net.py --gpu ${GPU_ID} \
  ...
  --net ${NET_FINAL} \
  --imdb ${TEST_IMDB} \
  --cfg experiments/cfgs/faster_rcnn_end2end_2012.yml \
  ${EXTRA_ARGS}
